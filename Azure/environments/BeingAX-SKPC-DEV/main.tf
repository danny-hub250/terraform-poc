...
module "vnet" {
  ...
  name                = "bax-gsm-dev-vnet"
  location            = var.location
  resource_group_name = module.rg.name
  address_space = ["10.100.0.32/27"]
  tags = var.tags
}
